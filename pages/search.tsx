...
type Props = {
    searchResults: searchResualt[]
}

const Search: NextPage = ({ searchResults }: Props) => {
        ...
        <div>
            ...
            <main className="flex ">
                <section className="flex-grow pt-14 px-6">
                    <p className="text-xs">300+ stays - {range} -  for {noOfGuests} numer of guests</p>

                    <h1 className="text-3xl font-semibold mt-2 mb-6">Stays in {location}</h1>

                    <div className="hidden lg:inline-flex mb-6 space-x-3 text-gray-800 whitespace-nowrap">
                        <p className="button">Cancellation Felexiblity</p>
